...
* The original package name 'com.eCommerceProject.Spring-cloud-config-service' is invalid and this project uses 'com.eCommerceProject.Springcloudconfigservice' instead.
